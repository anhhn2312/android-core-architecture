...
import com.andyha.coredata.manager.SupportedLanguagesProvider
import com.andyha.coredata.manager.SupportedLanguagesProviderImpl
...
class LocaleManagerImpl @Inject constructor(
    ...
    private val supportedLanguagesProvider: SupportedLanguagesProvider by lazy {
        SupportedLanguagesProviderImpl()
    }
    ...
    override fun getSupportedLanguages(context: Context): List<Pair<Locale, Int>> {
        return supportedLanguagesProvider.provideSupportedLanguages(context)
    }
